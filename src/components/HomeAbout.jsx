...
import { FaUtensils, FaLeaf, FaSmile, FaTruck } from 'react-icons/fa'; // Importing icons from React Icons

const HomeAbout = () => {
  const features = [
    {
      icon: <FaUtensils className="text-gray-400 text-6xl" />, // Adjust color to fit your scheme
  ...
  return (
    <div className="py-24 bg-sky-50 px-10 md:px-8 lg:px-32">
